...
class Installer
{
    ...
    /**
     * Enabled automatically installation of missing php extensions
     * 
     * @param bool $autoExtLoader
     * @return Installer
     */
    public function setAutoExtLoader($autoExtLoader = false){
        $this->autoExtLoader = (bool) $autoExtLoader;
        return $this;
    }
